...
/**
 * CreateNetworkPoolResponse Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class CreateNetworkPoolResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateNetworkPoolResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['joined'] === null) {
            $invalidProperties[] = "'joined' can't be null";
        }
