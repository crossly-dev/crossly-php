...
/**
 * GetOrderEvidenceResponseGrade Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderEvidenceResponseGrade implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderEvidenceResponse_grade';
    ...
    protected static $openAPITypes = [
        'grade' => 'string',
        'points' => 'float',
        'signals' => '\Crossly\Buyer\Model\GetOrderEvidenceResponseGradeSignals[]',
        'next_step' => 'string'
    ];
    ...
    const GRADE_BASIC = 'basic';
    const GRADE_CONCLUSIVE = 'conclusive';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['next_step'] = $data['next_step'] ?? null;
    }
     ...
     * Gets signals
     *
     * @return \Crossly\Buyer\Model\GetOrderEvidenceResponseGradeSignals[]
     */
     ...
     * Sets signals
     *
     * @param \Crossly\Buyer\Model\GetOrderEvidenceResponseGradeSignals[] $signals signals
     *
     * @return self
     */
     ...
     * Sets next_step
     *
     * @param string|null $next_step The single most valuable thing not yet done, phrased as an action.  One, not a checklist. A seller given six things to fix does none of them; a seller given the one worth the most does that one.
     *
     * @return self
     */
