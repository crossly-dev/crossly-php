...
/**
 * UpdatePolicyPresetResponse Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePolicyPresetResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePolicyPresetResponse';
     ...
     * Sets kind
     *
     * @param string $kind 'return' | 'shipping' | 'payment' — validated at the route layer.
     *
     * @return self
     */
     ...
     * Sets is_default
     *
     * @param bool $is_default Auto-selected on new listings. At most one true per (user, kind).
     *
     * @return self
     */
