...
/**
 * ListCbxRedemptionServicesItem Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class ListCbxRedemptionServicesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCbxRedemptionServicesItem';
    ...
    const LABEL_CARD___COMIC_GRADING_SUBMISSION = 'Card / comic grading submission';
    const LABEL_ITEM_AUTHENTICATION = 'Item authentication';
    const LABEL_EVIDENCE_SEAL__CONDITION_PROOF = 'Evidence seal (condition proof)';
    const LABEL_CROSSLY_SUBSCRIPTION = 'Crossly subscription';
    ...
    {
        return [
            self::LABEL_CARD___COMIC_GRADING_SUBMISSION,
            self::LABEL_ITEM_AUTHENTICATION,
            self::LABEL_EVIDENCE_SEAL__CONDITION_PROOF,
            self::LABEL_CROSSLY_SUBSCRIPTION,
        ];
    }
