...
class ErrorError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets code
     *
     * @param string $code Stable across versions — branch on this, not on the message.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string $message Human-readable. May change.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param mixed|null $details Optional structured context.
     *
     * @return self
     */
