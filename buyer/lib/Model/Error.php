 ...
 *
 * @category Class
 * @description Every 4xx and 5xx from this API.
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'error' => '\Crossly\Buyer\Model\ErrorError',
     ...
     * Gets error
     *
     * @return \Crossly\Buyer\Model\ErrorError
     */
     ...
     * Sets error
     *
     * @param \Crossly\Buyer\Model\ErrorError $error error
     *
     * @return self
     */
     ...
     * Sets correlation_id
     *
     * @param string|null $correlation_id Thread this back to server logs when reporting a problem.
     *
     * @return self
     */
