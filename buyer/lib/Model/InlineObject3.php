...
class InlineObject3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['amount_cents'] < 100)) {
            $invalidProperties[] = "invalid value for 'amount_cents', must be bigger than or equal to 100.";
        }
    ...
    public function setAmountCents($amount_cents)
    {
        ...
        if (($amount_cents < 100)) {
            throw new \InvalidArgumentException('invalid value for $amount_cents when calling InlineObject3., must be bigger than or equal to 100.');
        }
    ...
    {
        if (!is_null($message) && (mb_strlen($message) > 500)) {
            throw new \InvalidArgumentException('invalid length for $message when calling InlineObject3., must be smaller than or equal to 500.');
        }
