...
/**
 * GetOrderEvidenceResponseSealAssessment Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderEvidenceResponseSealAssessment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderEvidenceResponse_seal_assessment';
    ...
    const VERDICT_OPENED = 'opened';
    const VERDICT_INTACT = 'intact';
    const VERDICT_SUSPECT = 'suspect';
     ...
     * Sets headline
     *
     * @param string $headline One sentence for a human who will read nothing else.
     *
     * @return self
     */
