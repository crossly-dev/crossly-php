...
/**
 * CreateMagicScanSynthesizeResponsePayloadChosenDimensions Class Doc Comment
 *
 * @category Class
 * @description Seller-picked package size (inches). Beats the synthesizer&#39;s estimate —  see where it is applied.
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CreateMagicScanSynthesizeResponsePayloadChosenDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMagicScanSynthesizeResponse_payload_chosenDimensions';
    ...
    {
        $this->container['length_in'] = $data['length_in'] ?? null;
        $this->container['width_in'] = $data['width_in'] ?? null;
        $this->container['height_in'] = $data['height_in'] ?? null;
    }
     ...
     * Sets length_in
     *
     * @param float|null $length_in length_in
     *
     * @return self
     */
     ...
     * Sets width_in
     *
     * @param float|null $width_in width_in
     *
     * @return self
     */
     ...
     * Sets height_in
     *
     * @param float|null $height_in height_in
     *
     * @return self
     */
