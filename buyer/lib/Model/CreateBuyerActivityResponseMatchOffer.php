...
/**
 * CreateBuyerActivityResponseMatchOffer Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class CreateBuyerActivityResponseMatchOffer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateBuyerActivityResponse_match_offer';
     ...
     * Sets condition
     *
     * @param string|null $condition Free-text on listings, an order-book grade ('DS') on asks. Never null on asks; frequently null on listings, which is itself informative.
     *
     * @return self
     */
     ...
     * Sets available
     *
     * @param float|null $available How many the seller has. Caps the quantity stepper honestly.
     *
     * @return self
     */
