...
/**
 * GetBuyerScanSessionResponse Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class GetBuyerScanSessionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetBuyerScanSessionResponse';
    ...
    protected static $openAPITypes = [
        ...
        'capture_count' => 'float',
        'saved_cents' => 'float',
        'captures' => '\Crossly\Buyer\Model\GetBuyerScanSessionResponseCaptures[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['saved_cents'] = $data['saved_cents'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['saved_cents'] === null) {
            $invalidProperties[] = "'saved_cents' can't be null";
        }
     ...
     * @return float
     */
    public function getSavedCents()
    {
        return $this->container['saved_cents'];
    }

    /**
     * Sets saved_cents
     *
     * @param float $saved_cents Sum of measured savings. Unmeasured captures contribute 0, not null.
     *
     * @return self
     */
    public function setSavedCents($saved_cents)
    {
        $this->container['saved_cents'] = $saved_cents;
     ...
     * Gets captures
     *
     * @return \Crossly\Buyer\Model\GetBuyerScanSessionResponseCaptures[]
     */
     ...
     * Sets captures
     *
     * @param \Crossly\Buyer\Model\GetBuyerScanSessionResponseCaptures[] $captures captures
     *
     * @return self
     */
