...
/**
 * GetPatternResponse Class Doc Comment
 *
 * @category Class
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 ...
 */
class GetPatternResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetPatternResponse';
    ...
    {
        $this->container['patterns'] = $data['patterns'] ?? null;
    }
