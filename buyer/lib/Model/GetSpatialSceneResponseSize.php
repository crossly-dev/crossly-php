...
/**
 * GetSpatialSceneResponseSize Class Doc Comment
 *
 * @category Class
 * @description Real dimensions when the catalog knows them. Else the profile default.
 * @package  Crossly\Buyer
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GetSpatialSceneResponseSize implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSpatialSceneResponse_size';
