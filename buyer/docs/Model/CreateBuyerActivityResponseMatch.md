...
------------ | ------------- | ------------- | -------------
**verdict** | **string** |  |
**offer** | [**\Crossly\Buyer\Model\CreateBuyerActivityResponseMatchOffer**](CreateBuyerActivityResponseMatchOffer.md) |  |
**saving_cents** | **float** | Positive when cheaper. Null when no page price was supplied. | [optional]
